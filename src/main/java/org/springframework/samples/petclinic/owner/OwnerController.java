...
import com.jc.tri.mapper.TestMapper;
...
//	@ResponseBody
//	public String testMapper() throws Exception {
//		List<BizPlan> list = mapper.selectPlan();
...
//	}
	...
	@LogExcutionTime
	public String bean() {
		return "bean : " + applicationContext.getBean(OwnerRepository.class) + "</br>"
				+ " owners : " + this.owners;
	}
